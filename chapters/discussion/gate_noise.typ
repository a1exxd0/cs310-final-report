...
and Deng @Ma_2024 partially close this gap and provide some analytic perspective in which the
cliff observed at $n gt.eq 6$ can be interpreted.

Ma et al. @Ma_2024 consider two noise models the original Caro et al. @Caro_2023 paper does not. The
