...
treated as a black-box channel whetre they prove that 1-agnostic verifiability survives under some
conditions. Both bounds are output-side: per gate depolarising noise does not appear directly in
either statement and formalized theory is yet to be explored here.
